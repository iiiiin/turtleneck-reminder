...
|------|-------|------|------|
| 0분 ~ | ![neckno](images/neck_no.png) | ![giraffeno](images/giraffe_no.png) | 좋은 자세예요! |
| 첫 번째 알림 시간 ~ | ![neckshort](images/neck_short.png) | ![giraffeshort](images/giraffe_short.png) | 자세를 점검해주세요 |
| 두 번째 알림 시간 ~ | ![necklong](images/neck_long.png) | ![giraffelong](images/giraffe_long.png) | 지금 바로 스트레칭하세요! |
